...
if __name__ == "__main__":
    ...
    df_baseline_electricity_demand.to_csv(snakemake.output["baseline_electricity_demand"])
    logger.info(f"Baseline electricity demand data saved to {snakemake.output["baseline_electricity_demand"]}")
